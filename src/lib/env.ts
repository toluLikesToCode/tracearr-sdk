...
export interface Env {
  TRACEARRSDK_BEARER_AUTH?: string | undefined;

  TRACEARRSDK_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  TRACEARRSDK_BEARER_AUTH: z.optional(z.string()),

  TRACEARRSDK_DEBUG: z.optional(z.coerce.boolean()),
});
